      ...
      try {
        ...
        const sampleTournaments = [
          ...
          },
          {
            ...
            prizePool: 1000,
            format: 'single-elimination',
            organizer: 'Summer Series',
            description: 'High-energy summer tournament with great prizes.'
          },
          {
            id: 6,
            ...
            prizePool: 500,
            format: 'double-elimination',
            organizer: 'Monthly League',
            description: 'Monthly tournament for intermediate to advanced players.'
          }
        ];
